      ...
      <div className="container mx-auto lg:w-1/2 xl:w-1/2">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-sm">
          ...
          <div>
            ...
            <ul className="space-y-1">
              <li><a href="/en/blog" className="hover:text-accent">Blog & Tutorials</a></li>
              <li><a href="/en/about" className="hover:text-accent">About Us</a></li>
              <li><a href="/en/contact" className="hover:text-accent">Contact</a></li>
            </ul>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="text-xs">
              Free online timestamp conversion tools for developers and data analysts. Available in 12+ languages.
            </p>
          </div>
        </div>
